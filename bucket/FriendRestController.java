...
//    public ResponseEntity<List<Friend>> findFriendsByUserAndStatus(@PathVariable Long userId,
//                                                                   @PathVariable String status) {
//        List<Friend> list = friendsDataService.findFriendsByStatusAndUser(userId, FriendStatusEnum.valueOf(status.toUpperCase()));
//
//        if (list.isEmpty()) {
...
//        List<Friend> list = friendsDataService.findAll();
//
//        if (list.isEmpty()) {
//            return ResponseEntity.noContent().build();
//        }
